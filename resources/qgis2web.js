...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [11624249.993669, -611590.617823, 11627355.183883, -610060.809796], maxZoom: 28, minZoom: 1
    })
});

//initial view - epsg:3857 coordinates if not "Match project CRS"
map.getView().fit([11624249.993669, -611590.617823, 11627355.183883, -610060.809796], map.getSize());
    ...
    element: (() => {
        ...
        if (312 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Nomor : SK.10761/MENLHK-PSKL/PKPS/PSL.0/9/2023<br />Tanggal : 29 September 2023<br />Lokasi : Desa Srikaton, Kecamatan Semaka, Kabupaten Tanggamus, Provinsi Lampung<br />UPTD : KPHL Kota Agung Utara<br />Fungsi : Hutan Lindung<br />KHL : Register 31 Pematang Arahan<br />DAS : Way Seputih - Way Sekampung<br />Luas : +/- 31,16 Ha<br />';
            }

            hideAbstract();
        } else {
            linkElement.classList.add("project-abstract-uncollapsed");
            linkElement.innerHTML = '<br />Nomor<br /> : <br />SK.10761/MENLHK-PSKL/PKPS/PSL.0/9/2023<br />Tanggal<br /> : <br />29 September 2023<br />Lokasi<br /> : <br />Desa Srikaton, Kecamatan Semaka, Kabupaten Tanggamus, Provinsi Lampung<br />UPTD<br /> : <br />KPHL Kota Agung Utara<br />Fungsi<br /> : <br />Hutan Lindung<br />KHL<br /> : <br />Register 31 Pematang Arahan<br />DAS<br /> : <br />Way Seputih - Way Sekampung<br />Luas<br /> : <br />+/- 31,16 Ha<br />';
        }
...
attributionList.innerHTML = `
	...
	<a href="https://rumah-petani.github.io/web//">RUMAHPETAni</a>	
`;
